  ...
  return (
    ...
    <div className="min-h-screen bg-background/90 print:!bg-zinc-950 dark:print:!bg-white print:min-h-screen print:w-full print:p-6 print:box-border">
      ...
      <div className="py-12 print:p-0">
        ...
        <main className="w-auto md:w-[210mm] mx-4 md:mx-auto border-0 md:border-2 border-foreground p-0 md:p-6 shadow-xl print:!shadow-none print:border-0 print:p-0 rounded-xl print:rounded-xl overflow-hidden isolate bg-zinc-950 dark:bg-white print:w-full print:h-full print:m-0">
          <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] print:grid-cols-[300px_1fr] min-h-[297mm] print:min-h-0">
            ...
            <div className="md:hidden print:hidden p-8 pb-8 text-zinc-100 dark:text-zinc-900">
            ...
            <aside className="print:p-0">
              ...
              <div className="bg-white text-zinc-900 p-6 md:p-12 flex flex-col gap-8 print:!flex print:p-8 print:h-full dark:bg-zinc-900 dark:text-zinc-100 h-full rounded-xl mx-8 md:mx-0 print:mx-0">
            ...
            <div className="bg-zinc-950 px-8 pb-8 pt-8 md:px-12 md:pb-12 md:pt-12 print:px-8 print:pb-8 print:pt-6 dark:bg-white text-zinc-100 dark:text-zinc-900 h-full rounded-xl">
              {" "}
